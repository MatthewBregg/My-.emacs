...
;;;;;;  "evil-nerd-commenter" "evil-nerd-commenter.el" (21290 25312))
...
;;;;;;  evilnc-toggle-comment-empty-lines evilnc-toggle-invert-comment-line-by-line
;;;;;;  evilnc-comment-or-uncomment-to-the-line evilnc-comment-or-uncomment-paragraphs)
;;;;;;  "evil-nerd-commenter_flymake" "evil-nerd-commenter_flymake.el"
;;;;;;  (21290 25312))
;;; Generated autoloads from evil-nerd-commenter_flymake.el

(autoload 'evilnc-comment-or-uncomment-paragraphs "evil-nerd-commenter_flymake" "\
Comment or uncomment paragraph(s). A paragraph is a continuation non-empty lines.
Paragraphs are separated by empty lines.

\(fn &optional NUM)" t nil)

(autoload 'evilnc-comment-or-uncomment-to-the-line "evil-nerd-commenter_flymake" "\
Comment or uncomment from the current line to the LINENUM line

\(fn &optional LINENUM)" t nil)

(autoload 'evilnc-toggle-invert-comment-line-by-line "evil-nerd-commenter_flymake" "\


\(fn)" t nil)

(autoload 'evilnc-toggle-comment-empty-lines "evil-nerd-commenter_flymake" "\


\(fn)" t nil)

(autoload 'evilnc-comment-or-uncomment-lines "evil-nerd-commenter_flymake" "\
Comment or uncomment NUM lines. NUM could be negative.
   Case 1: If no region selected, comment/uncomment on current line. if NUM>1, comment/uncomment
   extra N-1 lines from next line
   Case 2: If a region selected, the region is expand to make sure the region contain
...
(autoload 'evilnc-copy-and-comment-lines "evil-nerd-commenter_flymake" "\
Copy and paste NUM lines. Then comment the original lines. NUM could be negative.
   Case 1: If no region selected, operate on current line. if NUM>1, comment/uncomment
   extra N-1 lines from next line
   Case 2: If a region selected, the region is expand to make sure the region contain
...
(autoload 'evilnc-copy-to-line "evil-nerd-commenter_flymake" "\
Copy from the current line to the LINENUM line, for non-evil user only

\(fn &optional LINENUM)" t nil)

(autoload 'evilnc-kill-to-line "evil-nerd-commenter_flymake" "\
Kill from the current line to the LINENUM line, for non-evil user only

\(fn &optional LINENUM)" t nil)

(autoload 'evilnc-default-hotkeys "evil-nerd-commenter_flymake" "\
Set the hotkeys of evil-nerd-comment
...
;;;***

;;;### (autoloads nil nil ("evil-nerd-commenter-pkg.el") (21290 25313
;;;;;;  77793))
